...
global.owner = process.env.OWNER_NUMBER  || '923039774224' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=aZt0VAYK#eAv526xvPQTawrnqCoriXN2SS25iWuSCOVs3O3GeCy4'
